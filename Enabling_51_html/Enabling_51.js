$(document).ready(function() {
	...
	cssFilename = "styles/enabling_51_dlilearn.css";
	xmlFilename = mediaPath + "enabling51_noNamespaces.xml";
	jsonFilename = mediaPath + "enabling51_json.js";
...
function loadSet(value){
	...
	$("#tlOrigSentenceDiv").html(tl_sentence);	
...
//		$('#rightAudioBtn').css({'float':'right','marginRight':'10px','marginTop':'-65px'});
		$('.tlOrigSentence').css({'text-align':'right'} );
		$('.enSentence').css({'text-align':'left','marginTop':'-10px'} );		
