...
function showFeedback(value, textInput){
	...
	switch(value){
		case "incorrect":
			$("#feedbackHeader").html('<img src="../common/img/feedback_incorrect.png" width="120px" height:24px">');
			$("#feedbackText").html(text);
			break;
		case "correct":
			$("#feedbackHeader").html('<img src="../common/img/feedback_correct.png" width="120px" height:24px">');
			$("#feedbackText").html(text);
			break;
		case "set_completed":
