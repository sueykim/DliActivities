$(document).ready(function() {
	...
	cssFilename = "styles/Capstone_01_default.css";
	...
	// For assessment
	//xmlFilename = mediaPath + "ad_01_08_15_08_noNamespaces.xml";
	//jsonFilename = mediaPath + "ad_01_08_15_08_noNamespaces.js";
	
	// For performance
	//xmlFilename = mediaPath + "vb_02_01_06_01_noNamespaces.xml";
	//jsonFilename = mediaPath + "vb_02_01_06_01_noNamespaces.js";
...
function loadSet(value){
	...
	for(var i  = 1; i<5; i++){
		...
		if (!isJapanese) {
			...
			// To display ruby tag
			$('#choiceText_' + i).html(
				displayRubyTag($($(xml).find("choice")[(currentSet*numItemsPerSet) + i - 1]).text())
			);			
		}
