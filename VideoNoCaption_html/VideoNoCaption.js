$(document).ready(function() {
	testVideoSupport();
		...
		xmlFilename = mediaPath + "levantine_VideoNoCaption_noNamespaces.xml";
		jsonFilename = mediaPath + "levantine_VideoNoCaption_noNamespaces.js";
...
/*
	...
	cssFilename = "styles/VideoNoCaption.css";
...
function parseXml(t_xml){
	...
	/*  ********* No Caption ************** $("#tlLang").text($(xml).find("content").attr("target_language")); ********** ******/
	...
	isJapanese = $(xml).find("content").attr("target_language") == "Japanese";
        ////disableCaption  = $(xml).find("content").attr("disableCaption") == "true";
        ////disableTitleBar  = $(xml).find("content").attr("disableTitleBar") == "true";
}
