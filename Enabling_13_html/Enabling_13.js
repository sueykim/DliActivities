...
function loadSet(value){
	...
	$("#videoContainer1").addClass('no_video_mark');
	...
	$("#videoContainer2").html('<img  class="no_video_mark" src="../common/img/no_video_v2.png" style="width:70px; height: 70px;" border="0">');
	}
...
function showSubmitBtn(NO){
        for (var i=0; i<3; i++)
            if (i != NO)
	       $("#submitBtn" + i).css('display', 'none');
	var theSubmitBtnID = "#submitBtn" + NO;
	$(theSubmitBtnID).css('display', 'inline');
}
