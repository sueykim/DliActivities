...
//function  setSmudgeForBomArea() {
	 	 //$("#bomTarget").attr("src", "images/dark_smudge.png");
	 	// $("#bomTarget").css({opacity:0});
	 	// $("#bomTarget").animate({opacity:1},2000, 'linear');
		// $("#bomTarget").css({width:"720px", height:"480px"});
//}
function html5AudioPlayFinished()
			{
				if (bomExplosion) {
					bomExplosion=false;
					popUpMessage();
