...
function loadSet(value){
	...
	for(var i = 0; i< 3; i++){
		...
		if (!isJapanese) {
			...
			// To display ruby tag
			$("#id_text" + i).html(displayRubyTag(enTextAry[a]));
		}
...
function checkAnswers(){
	...
	answerAttempts = (crrtNumber/numSets)*100; ////answerAttemptsNum.toString();
	

	////alert('scores=' + answerAttempts)
	// To see attempts - temp
	//$("#feedbackText").html("Homework//scores: " + answerAttempts);
