        ...
        $(".image").each(function(index){
          ...
          $(this).click(function(){
            if(imgFades[currentSet] == 1){
               ...
               var splitNumbers = thisImage.split("/")
               var lastN = splitNumbers.length -1
               var answerImage = thisImage.split("/")[lastN]
...
function showFeedback(value, text){
	...
	switch(value){
		...
		case "activity_completed":
			...
			$("#feedbackText").html(text);
			break;
		case "activity_completed_fail":
			$("#feedbackHeader").html("Activity Incomplete");
			$("#feedbackText").html(text);
			break;
	}
