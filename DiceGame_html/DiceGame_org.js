...
function rollFinished(){
	...
	if(webglMode){
		...
		$("#img_dice1").attr("src", "sampleData/png/" + pronounDie + ".png")
		$("#img_dice2").attr("src", "sampleData/png/" + infinitiveDie + ".png")
...
function startUpNoWebGL(){
	...
	var file_video = "video.ogv";
	loadVideoNoPlayYet(mediaPath, removeFileExt(file_video), "DiceGame");
