...
/*
//var localPath = "file:///E:/_DLiLearn/_site";
var fileLoc = (location.href).toString();
var cutPoint = fileLoc.indexOf("/templates/");
var localPath = fileLoc.substr(0, cutPoint);
*/
...
function loadActivityData(t_xmlFilename, t_jsonFilename, t_activityDataLoadCallback){
	...
	if(xmlFilename == null){
		...
		//Load xml added these two lines to accommodate the stand-alone setting.. sk 20131022
		//xmlFilename = localPath + xmlFilename;
		//mediaPath = localPath + mediaPath;
		if (getURL_Parameter("mediaPath") != 'undefined'){
			xmlFilename = localPath + xmlFilename;
			mediaPath = localPath + mediaPath;
		}
		//alert(mediaPath)
