...
function dropFunction(event, ui ){
	...
	if(dropBtnLetter == dragBtnLetter){
		...
		if(letterIncorrectArray[dropBtnIndex] == 3){
...
// For homework
function checkAnswers(currentConversationIndexNum, itemNum){
	var questionID = "";
	var answer = "";
	var context = "";
	var answerAttempts = "";
	...
	questionID = parseInt(currentConversationIndexNum.toString()+ itemNum.toString());
	answer = "--";
	context = "--";
