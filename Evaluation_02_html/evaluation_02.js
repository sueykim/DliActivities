...
function checkAnswersHW(){
	...
	questionID = 0////parseInt(currentSet.toString());
	answer = "--";
	context = "--";
	answerAttempts = stScore * 100 ////answerAttemptsNum.toString();
	
	// To see attempts - temp
	//$("#feedbackText").html("Homework//answerAttempts: " + answerAttempts)////answerAttemptsNum.toString());
